...
//path configurations
std::string KALDI_ROOT  = "/data/local/tmp/SpeechRecognition";
std::string GRAPH_DIR   = KALDI_ROOT + "/tri3b/graph_word";
std::string DECODE_DIR  = KALDI_ROOT + "/tri3b/decode_test_word";
...
//MFCC configurations
std::string MFCC_config_path  = KALDI_ROOT + "/conf/mfcc.conf";
